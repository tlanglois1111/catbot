...
# Constants
DEFAULT_MODEL = '../dataset/tf/catbot-detection-graphs/catbot_detection_graph_v1.pb/frozen_inference_graph'
...
def open_display_window(width, height):
    ...
    cv2.setWindowTitle(WINDOW_NAME, 'Catbot Demo '
                                    'for Jetson Nano')
